...
export default function Page() {
  return (
    ...
    <div className=' pt-[20px] px-[50px] pb-[20px] ' id='about'>
      ...
      <p className=' text-center'>AGI Co. in one of the leading Apparel & accessories Manufacturing/Exporting Company across the globe and targets to become the world leading producer by providing quality, on-time delivery, cost saving, innovation and high-tech oriented solutions to the customers.</p>
      ...
      <p className=' text-center'>AGI Co. in history of a decade worth of commitment to quality and value. We aim to bring the latest and best of products to you as never done before. We design and manufacture all kinds Fashion/Sports Garments and accessories. We have also stared our sports goods manufacturing unit in 2020.</p>
      </div>
